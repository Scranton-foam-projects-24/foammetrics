...
def turning_distance(n, k):
    ...
    Mul(1/(n*k), Sum((Mul(1/k,floor(i/n), evaluate=0)-Mul(1/n,floor(i/k), evaluate=0))**2-(1/n-1/k)**2, (i, 0, k*n)), evaluate=0)
    return 1/(n*k)*Sum((1/k*floor(i/n)-1/n*floor(i/k))**2-(1/n-1/k)**2, (i, 0, k*n))
